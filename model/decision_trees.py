...
def decisiontree(data, oscar, subset_quantile):
  #Initialize output
  n_iteration = 1 
  result_dict = []
  ...
  for quantile in subset_quantile:
    ...
    predictions = clf.predict(xtest_enc)
    ...
    for n in range(len(oscar_years)):
      ...
      oscar_predictions = clf.predict(oscar_train)
...
result, oscar_pred = decisiontree(awards,oscars,quantile_list)
